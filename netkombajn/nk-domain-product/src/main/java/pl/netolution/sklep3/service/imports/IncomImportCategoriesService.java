...
public class IncomImportCategoriesService {

    private static final Logger log = Logger.getLogger(IncomImportCategoriesService.class);

    private final CategoryDao categoryDao;

    public IncomImportCategoriesService(CategoryDao categoryDao) {
