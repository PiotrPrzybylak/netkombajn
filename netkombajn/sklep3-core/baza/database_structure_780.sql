...
--
-- Host: localhost    Database: sklep3
-- ------------------------------------------------------
...
CREATE TABLE `configuration` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `picturesUploadFolder` varchar(255) NOT NULL,
  `layoutPrefix` varchar(255) NOT NULL,
  `maxNewProducts` int(10) unsigned NOT NULL,
  `importsUploadFolder` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4863 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2009-07-07 11:26:59
